/**
 * ToSAccessibilityAids - Skip-to-content link, breadcrumbs for ToS page.
 */
...
export interface ToSAccessibilityAidsProps {
  mainContentId?: string
  showBreadcrumbs?: boolean
  className?: string
}

export function ToSAccessibilityAids({
  mainContentId = 'tos-main',
  showBreadcrumbs = true,
  className,
}: ToSAccessibilityAidsProps) {
  return (
